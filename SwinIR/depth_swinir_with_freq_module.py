...
from sgnet.models.common import SDM

class SwinIR_Depth_Frequency(nn.Module):
    def __init__(self, img_size=64, patch_size=1, in_chans=3, embed_dim=96,
        ...
        super(SwinIR_Depth_Frequency, self).__init__()
...
if __name__ == '__main__':
    ...
    model = SwinIR_Depth_Frequency(img_size=hr_size, upscale=upscale, window_size=window_size).to(device)
